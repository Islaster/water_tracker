...
--
-- Name: waterlogschema; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA waterlogschema;


ALTER SCHEMA waterlogschema OWNER TO postgres;
...
--
-- Name: water_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.water_logs_id_seq OWNER TO postgres;

--
-- Name: water_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: water_logs id; Type: DEFAULT; Schema: public; Owner: postgres
--
